...
Good documentation for local development: https://docs.airbyte.io/contributing-to-airbyte/developing-locally

### Useful commands
* list of gladlew tasks (quick list): ./gradlew tasks
* list of all gradlew tasks: ./gradlew tasks --all
* rebuild destination s3 plugin: ./gradlew airbyte-integrations:connectors:destination-s3:build
